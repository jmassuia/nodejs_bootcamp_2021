...
var showAlert = function showAlert(type, message) {
  hideAlert(); //Creating alerts

  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>");
  document.querySelector("body").insertAdjacentHTML("afterbegin", markup); //Hiding alerts after 5s
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.status === 200) {
              (0, _alert.showAlert)("success", "Logged successfully!");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoiam9hby1tYXNzdWlhIiwiYSI6ImNrcXVhajllazAybmkyb3BiaGQwcXJxajEifQ.B7cQ4RKsF_RnCpINkEfFuA";
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to includ the currently locations
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            return _context.abrupt("return", (0, _alert.showAlert)("success", "User data updated successfully!!"));
          ...
          case 9:
            ...
            return _context.abrupt("return", (0, _alert.showAlert)("error", _context.t0));
...
var stripe = Stripe("pk_test_51JR4qEIi6kT4KaNDm9Mq9n4HrsRJsmMCT6klP0vQDDBY53oh1jU622PhtXlVCYcCLp0LRPZHaDFKVHP2w7Cerf1q000lUlorp6");
